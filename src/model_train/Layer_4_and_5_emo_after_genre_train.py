...
model = tf.keras.models.load_model(
    "Put the name of your model train on genre here",
...
model_checkpoint = ModelCheckpoint(
    "genre_to_emotion_l4_l5_{epoch}_{val_accuracy:.2f}_{val_f1_score:.2f}.keras",
    monitor="val_f1_score",
    mode="max",
    save_best_only=True,
)

# You can also monitor F1 score in EarlyStopping
early_stopping = EarlyStopping(monitor="val_f1_score", patience=100)
...
model.save("genre_to_emotion_l4_l5_final.keras")

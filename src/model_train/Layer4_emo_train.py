...
for layer in base_model.layers:
    if layer.name.startswith("conv4") or layer.name.startswith("input"):
...
model.add(Dense(1, activation="sigmoid"))  # 4 classes
...
model_checkpoint = ModelCheckpoint(
    "emo_l4_{epoch}_{val_accuracy:.2f}_{val_f1_score}.keras",
...
model.save("emo_l4_genre_to_emotion_clf_final.keras")
